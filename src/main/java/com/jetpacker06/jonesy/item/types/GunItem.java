...
public class GunItem extends AbstractItem {
    public int damage;
    public int shots_per_turn;
    public int hit_chance;
    public GunItem(String id, String display_name, int cooldown, int damage, int shots_per_turn, int hit_chance, Rarity rarity) {
